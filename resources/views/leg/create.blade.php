    ...
    <div class="max-w-md w-full bg-white p-6 rounded-lg shadow-lg">
        ...
        <form method="POST" action="{{ route('leg.update', $legDay->id) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="training" name="training" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
